...
public class CellBox {
    ...
    ) throws IllegalArgumentException 
    {
        ...
        try {
            ...
            // NOTE: Each cell has 26 neighbors. To avoid float counting of 
            ...
            this.cutOffLengthX = this.boxSize.getXLength()/(THREE * (float) tmpCellNumberThirdX);
            ...
            this.cutOffLengthY = this.boxSize.getYLength()/(TWO * (float) tmpCellNumberHalfY);
            ...
            this.cutOffLengthZ = this.boxSize.getZLength()/(THREE * (float) tmpCellNumberThirdZ);
        ...
        for (int tmpIndexX = 0; tmpIndexX < this.cellNumberX; tmpIndexX++) {
            for (int tmpIndexY = 0; tmpIndexY < this.cellNumberY; tmpIndexY++) {
                for (int tmpIndexZ = 0; tmpIndexZ < this.cellNumberZ; tmpIndexZ++) {
                    // There are 13 neighbour cells (without float counting of later pair interactions)
