...
public class InteractionDescription {
     ...
     */
    private final float dpdSigma;

    /**
     * DPD sigma parameter divided by root of time step length in DPD units
     */
    private final float dpdSigmaDivRootTimeStepLength;

    /**
     * DPD gamma parameter in DPD units
     */
    private final float dpdGamma;
    ...
    public InteractionDescription(
        ...
        // DPD sigma parameter divided by root of time step length in DPD units
        this.dpdSigmaDivRootTimeStepLength = this.dpdSigma/(float) FastMath.sqrt(aSimulationDescription.getTimeStepLength());
        ...
        this.dpdGamma = this.dpdSigma * this.dpdSigma / (2.0f * this.temperature);
    }
    // </editor-fold>
    //
     ...
     */
    public void setPnhln_Ksi(float aValue) {
     ...
     */
    public float getDpdSigmaDivRootTimeStepLength() {
