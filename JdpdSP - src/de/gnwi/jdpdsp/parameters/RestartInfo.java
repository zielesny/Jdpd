...
import de.gnwi.jdpd.parameters.RestartInfoBase;
    ...
    public RestartInfo(
        ...
        try {
            ...
            if (tmpLine.equals(VERSION_1_0_0)) {
                ...
                this.r_x = new float[tmpParticleNumber];
                this.r_y = new float[tmpParticleNumber];
                this.r_z = new float[tmpParticleNumber];
                this.v_x = new float[tmpParticleNumber];
                this.v_y = new float[tmpParticleNumber];
                this.v_z = new float[tmpParticleNumber];
                for (int i = 0; i < tmpParticleNumber; i++) {
                    this.r_x[i] = Float.valueOf(tmpBufferedReader.readLine());
                    this.r_y[i] = Float.valueOf(tmpBufferedReader.readLine());
                    this.r_z[i] = Float.valueOf(tmpBufferedReader.readLine());
                    this.v_x[i] = Float.valueOf(tmpBufferedReader.readLine());
                    this.v_y[i] = Float.valueOf(tmpBufferedReader.readLine());
                    this.v_z[i] = Float.valueOf(tmpBufferedReader.readLine());
                }
                // </editor-fold>
            } else {
