...
public class MoleculeTypes {
     ...
     */
    private final float[] moleculeMolarMasses;
     ...
     */
    public float getMoleculeMolarMass(String aMoleculeName) {
     ...
     * @return Molar mass of molecule
     */
    public float getMoleculeMolarMass(int anIndex) {
