...
public class ForceAccumulator {
    ...
    public boolean accumulate_f_and_fTwo(
        ...
        if (this.isFtwoAccumulation) {
            Arrays.fill(aParameters.getParticleArrays().getFtwo_x(), 0.0f);
            Arrays.fill(aParameters.getParticleArrays().getFtwo_y(), 0.0f);
            Arrays.fill(aParameters.getParticleArrays().getFtwo_z(), 0.0f);
        }
        // </editor-fold>
