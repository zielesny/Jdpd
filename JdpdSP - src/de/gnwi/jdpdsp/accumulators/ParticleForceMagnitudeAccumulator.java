 ...
 */
package de.gnwi.jdpdsp.accumulators;
...
public class ParticleForceMagnitudeAccumulator {
     ...
     */
    private float[] minMeanMaxDpdForceConservativeMagnitude;

    /**
     * Array of length 3 with min (index 0), mean (index 1) and 
     * max (index 2) magnitude of random DPD force magnitudes of particles
     */
    private float[] minMeanMaxDpdForceRandomMagnitude;

    /**
     * Array of length 3 with min (index 0), mean (index 1) and 
     * max (index 2) magnitude of dissipative DPD force magnitudes of particles
     */
    private float[] minMeanMaxDpdForceDissipativeMagnitude;
     ...
     * particles
     */
    private float[] minMeanMaxBondForceMagnitude;
     ...
     * of particles
     */
    private float[] minMeanMaxElectrostaticsForceMagnitude;
     ...
     * of particles
     */
    private float[] minMeanMaxTotalForceMagnitude;
    // </editor-fold>
    //
    ...
    public boolean analyzeParticleForceMagnitudes(
        ...
        try {
            ...
            if (this.fAux_x == null) {
                this.fAux_x = new float[aParameters.getParticleArrays().getF_x().length];
                this.fAux_y = new float[aParameters.getParticleArrays().getF_x().length];
                this.fAux_z = new float[aParameters.getParticleArrays().getF_x().length];
                this.fAuxTot_x = new float[aParameters.getParticleArrays().getF_x().length];
                this.fAuxTot_y = new float[aParameters.getParticleArrays().getF_x().length];
                this.fAuxTot_z = new float[aParameters.getParticleArrays().getF_x().length];
            }
            Arrays.fill(this.fAuxTot_x, 0.0f);
            Arrays.fill(this.fAuxTot_y, 0.0f);
            Arrays.fill(this.fAuxTot_z, 0.0f);
            Utils.copyToOld(
            ...
            Arrays.fill(aParameters.getParticleArrays().getF_x(), 0.0f);
            Arrays.fill(aParameters.getParticleArrays().getF_y(), 0.0f);
            Arrays.fill(aParameters.getParticleArrays().getF_z(), 0.0f);
     ...
     * max (index 2) magnitude of conservative DPD force magnitudes of particles
     */
    public float[] getMinMeanMaxDpdForceConservativeMagnitude() {
     ...
     * max (index 2) magnitude of random DPD force magnitudes of particles
     */
    public float[] getMinMeanMaxDpdForceRandomMagnitude() {
     ...
     * max (index 2) magnitude of dissipative DPD force magnitudes of particles
     */
    public float[] getMinMeanMaxDpdForceDissipativeMagnitude() {
     ...
     * particles
     */
    public float[] getMinMeanMaxBondForceMagnitude() {
     ...
     * of particles
     */
    public float[] getMinMeanMaxElectrostaticsForceMagnitude() {
     ...
     * of particles
     */
    public float[] getMinMeanMaxTotalForceMagnitude() {
