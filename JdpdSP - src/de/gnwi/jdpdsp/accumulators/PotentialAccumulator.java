...
import de.gnwi.jdpdsp.utilities.ExtendedAdderGroup;
...
public class PotentialAccumulator {
    ...
    public boolean accumulatePotentials(
        ...
        float tmpUpotDpd = this.particlePairDpdPotentialCalculator.getAccumulatedPotentialEnergyAddersSum();
        float tmpPressureXDpd = this.particlePairDpdPotentialCalculator.getAccumulatedPressureXAddersSum();
        float tmpPressureYDpd = this.particlePairDpdPotentialCalculator.getAccumulatedPressureYAddersSum();
        float tmpPressureZDpd = this.particlePairDpdPotentialCalculator.getAccumulatedPressureZAddersSum();
        ...
        if (this.harmonicBondPotentialCalculator != null) {
            ...
            float tmpUpotBonds = this.harmonicBondPotentialCalculator.getAccumulatedPotentialEnergyAddersSum();
            float tmpPressureXBonds = this.harmonicBondPotentialCalculator.getAccumulatedPressureXAddersSum();
            float tmpPressureYBonds = this.harmonicBondPotentialCalculator.getAccumulatedPressureYAddersSum();
            float tmpPressureZBonds = this.harmonicBondPotentialCalculator.getAccumulatedPressureZAddersSum();
            // <editor-fold defaultstate="collapsed" desc="Intermediate results logging">
        ...
        if (this.particlePairElectrostaticsPotentialCalculator != null) {
            ...
            float tmpUpotParticlePairElectrostatics = this.particlePairElectrostaticsPotentialCalculator.getAccumulatedPotentialEnergyAddersSum();
            float tmpPressureXParticlePairElectrostatics = this.particlePairElectrostaticsPotentialCalculator.getAccumulatedPressureXAddersSum();
            float tmpPressureYParticlePairElectrostatics = this.particlePairElectrostaticsPotentialCalculator.getAccumulatedPressureYAddersSum();
            float tmpPressureZParticlePairElectrostatics = this.particlePairElectrostaticsPotentialCalculator.getAccumulatedPressureZAddersSum();
            // <editor-fold defaultstate="collapsed" desc="Intermediate results logging">
