...
public class MoleculeRgValue {
     ...
     * 
     */
    public MoleculeRgValue(String aMoleculeName, float aRgValue) {
     ...
     * @param aRgValue Rg value
     */
    public final void setMoleculeRgValue(String aMoleculeName, float aRgValue) {
