 ...
 */
package de.gnwi.jdpdsp.samples.interactions;

import de.gnwi.jdpdsp.utilities.Factory;
import de.gnwi.jdpdsp.utilities.CellBox;
...
import de.gnwi.jdpdsp.utilities.CalculatorUtils;
 ...
 * generators, non thread-safe float adders and standard (NON atomic) float 
 * arrays.
 * 
...
public abstract class ParticlePairInteractionCalculator extends CellBox implements IParticlePairInteractionCalculator {
    ...
    private class CacheCalculationTask implements Callable<Boolean> {
        ...
        public Boolean call() {
            try{
                ...
                float[] tmpRij_x = this.particlePairDistanceParameters.getArray_Rij_x();
                float[] tmpRij_y = this.particlePairDistanceParameters.getArray_Rij_y();
                float[] tmpRij_z = this.particlePairDistanceParameters.getArray_Rij_z();
                float[] tmpRij_Square = this.particlePairDistanceParameters.getArray_Rij_Square();
                float[] tmpRij = this.particlePairDistanceParameters.getArray_Rij();
     ...
     */
    private final float cutOffLengthSquare;
 ...
 NOTE: getHeadParticleIndexOfCellArray() and getNextParticleIndexOfCellArray are
    ...
    public boolean calculateCellBasedParticlePairInteractionsWithParticleCellAssignments(
        ...
        try {
            ...
            // </editor-fold>
            // <editor-fold defaultstate="collapsed" desc="Reset float adders">
 ...
 (No checks are performed)
     ...
     */
    private int getIndexAlongX(float aPosition) {
     ...
     */
    private int getIndexAlongY(float aPosition) {
        // Fast implementation for positive values:
     ...
     */
    private int getIndexAlongZ(float aPosition) {
        // Fast implementation for positive values:
    ...
    private void evaluateParticlePairInteraction(
        ...
        float tmpCorrectedRij_x_Square = tmpCorrectedRij_x * tmpCorrectedRij_x;
        if (tmpCorrectedRij_x_Square < this.cutOffLengthSquare) {
            float tmpCorrectedRij_y = 
                Utils.correctPositionDifference(
            ...
            float tmpCorrectedRij_y_Square = tmpCorrectedRij_y * tmpCorrectedRij_y;
            if (tmpCorrectedRij_y_Square < this.cutOffLengthSquare) {
                float tmpCorrectedRij_z = 
                    Utils.correctPositionDifference(
                ...
                float tmpCorrectedRij_z_Square = tmpCorrectedRij_z * tmpCorrectedRij_z;
                if (tmpCorrectedRij_z_Square < this.cutOffLengthSquare) {
                    float tmpRij_Square = tmpCorrectedRij_x_Square + tmpCorrectedRij_y_Square + tmpCorrectedRij_z_Square;
