 ...
 */
package de.gnwi.jdpdsp.samples.random;
...
public class ApacheCommonsRandom implements IRandom {
    ...
    private final float SQRT_12 = (float) FastMath.sqrt(12.0);
    private final float A_HALF = 0.5f;
    ...
    public ApacheCommonsRandom(RandomSource aRandomSource, int aSeed, int aNumberOfWarmUpSteps) {
        ...
        for (int i = 0; i < aNumberOfWarmUpSteps; i++) {
            this.randomNumberGenerator.nextFloat();
        }
        // </editor-fold>
     ...
     */
    @Override
    public float nextZeroMeanUnitVarianceFloat() {
        return this.SQRT_12 * (this.randomNumberGenerator.nextFloat() - this.A_HALF);
    }
    ...
    public float nextGaussian() {
        return (float) this.gaussianSampler.sample();
    }
