...
public class ParticleIndexPairRandomCalculatorForTesting extends ParticlePairInteractionCalculator {
 ...
 (see ParticlePairInteractionCalculator for details)
    ...
    protected void calculateParticlePairInteraction(
        ...
        aParameters.getTestObjects().getParticleIndexPairRandomQueue().add(this.getIndexPairRandom(aParticleIndex_i, aParticleIndex_j, aRandomAdderGroup.getRandomNumberGenerator().nextFloat()));
     ...
     */
    private String getIndexPairRandom(int aParticleIndex_i, int aParticleIndex_j, float aRandomNumber) {
