...
/**
 * Particle pair DPD dissipative force calculator that uses 
 ...
 */
public class ParticlePairDpdForceDissipativeCutoff1Calculator extends ParticlePairInteractionCalculator implements IParticlePairForceCalculator {
     ...
     */
    public ParticlePairDpdForceDissipativeCutoff1Calculator(
        Factory aFactory,
        ...
        this.simulationLogger.appendMethodCall("ParticlePairDpdForceDissipativeCutoff1Calculator.Constructor: FULL");
        // </editor-fold>
    }
 ...
 (see ParticlePairInteractionCalculator for details)
     ...
     * @throws IllegalArgumentException Thrown if an argument is illegal
     */
    public ParticlePairDpdForceDissipativeCutoff1Calculator(IParticlePairInteractionCalculator aParticlePairInteractionCalculator) throws IllegalArgumentException {
        super(aParticlePairInteractionCalculator);
        // <editor-fold defaultstate="collapsed" desc="Method call logging">
        this.simulationLogger.appendMethodCall("ParticlePairDpdForceDissipativeCutoff1Calculator.Constructor WITH aParticlePairInteractionCalculator");
        // </editor-fold>
    }
    // </editor-fold>
    //
    ...
    protected void calculateParticlePairInteraction(
        ...
        final double tmpFij_x = tmpFactor_v_dot_r * aRij_x;
        final double tmpFij_y = tmpFactor_v_dot_r * aRij_y;
        final double tmpFij_z = tmpFactor_v_dot_r * aRij_z;
