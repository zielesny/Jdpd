...
public class ParticleTypes {
     ...
     */
    private final double minimumMolarMass;
    // </editor-fold>
    //
    ...
    public ParticleTypes(
        ...
        double tmpMinimumMolarMass = aMolarMasses[0];
     ...
     */
    public double getMolarMass(String aToken) {
     ...
     * @return Molar mass of particle in g/mol
     */
    public double getMolarMass(int anIndex) {
     ...
     */
    public double getMinimumMolarMass() {
     ...
     */
    public double getCharge(String aToken) {
     ...
     * @return Charge of particle
     */
    public double getCharge(int anIndex) {
