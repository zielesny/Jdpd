 ...
 */
public class ParticleIndexPairCalculatorForTesting extends ParticlePairInteractionCalculator {
     ...
     */
    public ParticleIndexPairCalculatorForTesting(
        Factory aFactory,
 ...
 (see ParticlePairInteractionCalculator for details)
     ...
     * @throws IllegalArgumentException Thrown if an argument is illegal
     */
    public ParticleIndexPairCalculatorForTesting(ParticlePairInteractionCalculator aParticlePairInteractionCalculator) throws IllegalArgumentException {
    ...
    protected void calculateParticlePairInteraction(
        ...
        aParameters.getTestObjects().getParticleIndexPairQueue().add(new int[] {aParticleIndex_i, aParticleIndex_j});
