...
public class ParticlePairDistanceParameters {
     ...
     */
    private final LinkedList<double[]> arrayList_Rij_x;

    /**
     * List for Rij_y arrays
     */
    private final LinkedList<double[]> arrayList_Rij_y;

    /**
     * List for Rij_z arrays
     */
    private final LinkedList<double[]> arrayList_Rij_z;

    /**
     * List for Rij_Square arrays
     */
    private final LinkedList<double[]> arrayList_Rij_Square;

    /**
     * List for Rij arrays
     */
    private final LinkedList<double[]> arrayList_Rij;
    // </editor-fold>
    //
     ...
     * Rij_x array
     */
    private double[] array_Rij_x;
    
    /**
     * Rij_y array
     */
    private double[] array_Rij_y;
    
    /**
     * Rij_z array
     */
    private double[] array_Rij_z;
    
    /**
     * Rij_Square array
     */
    private double[] array_Rij_Square;
    
    /**
     * Rij array
     */
    private double[] array_Rij;
    ...
    public ParticlePairDistanceParameters(int aCapacity) {
        ...
        this.array_Rij_x = new double[this.capacity];
        this.array_Rij_y = new double[this.capacity];
        this.array_Rij_z = new double[this.capacity];
        this.array_Rij_Square = new double[this.capacity];
        this.array_Rij = new double[this.capacity];
     ...
     */
    public double[] getArray_Rij_Square() {
        if (!this.isConsolidated) {
            this.consolidate();
        }
    ...
    private void consolidate() {
        if (!this.isConsolidated) {
            ...
            this.array_Rij_x = 
                this.getConsolidatedDoubleArray(
                    tmpNewArraySize,
            ...
            this.array_Rij = 
                this.getConsolidatedDoubleArray(tmpNewArraySize,
                    this.arrayList_Rij,
                    this.array_Rij
                );
     ...
     * @param anArrayList Array list with arrays to consolidate
     * @param aLastArray Last array to be consolidated
     * @return Consolidated double array
     */
    private double[] getConsolidatedDoubleArray(
        int tmpNewArraySize,
        LinkedList<double[]> anArrayList,
        double[] aLastArray
    ) {
        double[] tmpNewArray = new double[tmpNewArraySize];
        int tmpIndex = 0;
        for (double[] tmpSingleArray : anArrayList) {
            System.arraycopy(
                tmpSingleArray, 
                0, 
                tmpNewArray, 
